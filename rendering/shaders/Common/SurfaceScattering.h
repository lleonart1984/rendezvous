#ifndef SURFACE_SCATTERING_H
#define SURFACE_SCATTERING_H
...
//void d_DiffuseScatter(
//inout uvec4 rng_seed,
//in vec3 N,
//in float diff,
//out vec3 w_out,
//out float brdf_cos,
//out float pdf,
//out float d_brdf_cos_diff,
//out vec3 d_brdf_cos_N
//)
//{
//
//}
...
)
{
    ...
    if (xi < material.Model.x)// Diffuse
    {
        ...
        brdf_cos = material.Diffuse * NdotL;
        pdf = NdotL;
        P += fN*0.000001;
        return;
    }
